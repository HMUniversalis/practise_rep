...
def start_game():
    ...
    def auto():
        if snake_photo == position_0:
            ...
            if snake_queue[0]==3:
                val_2 = 50
            print(f'Fidi deksia:{val_1}, Fidi kato:{val_2}')    
            if val_1 >= val_2:
            ...
            print(f'Fidi aristera:{val_1}, Fidi deksia:{val_2}, Fidi kato:{val_3}')
            if len(min_heuristic_positions)==1:  
                if val_1 >= val_3 and val_2>=val_3:
                    change_position(position_4)
                    refresh_game()
                elif val_1 >=val_2 and val_3>=val_2:
                ...
                position_number = int(random.choice(min_heuristic_positions)) # if two or more heuristics are equal i randomize the choice of the path to avoid infinite loop 
            ...
            if snake_queue[0]==5:
                val_2 = 50
            print(f'Fidi aristera:{val_1}, Fidi kato:{val_2}')    
            if val_1 >= val_2:
            ...
            if snake_queue[0]==6:
                val_3 = 50   
            min_heuristic_positions = find_min_heuristic([val_1,val_2,val_3])
            print(f'Fidi pano:{val_1}, Fidi deksia:{val_2}, Fidi kato:{val_3}')
            if len(min_heuristic_positions)==1:
                if val_1 >= val_3 and val_2>=val_3:
            ...
            print(f'Fidi pano:{val_1}, Fidi aristera:{val_2}, Fidi deksia:{val_3}, Fidi kato:{val_4}')
            if len(min_heuristic_positions)==1: 
                if val_1 >= val_4 and val_2>=val_4 and val_3 >= val_4:
                    change_position(position_7)
                    refresh_game()
                elif val_1 >= val_3 and val_2>=val_3 and val_4 >= val_3:
                    change_position(position_5)
                    refresh_game()
                elif val_1 >= val_2 and val_3>=val_2 and val_4 >= val_2:
                    change_position(position_3)
                    refresh_game()
                else:
                    change_position(position_1)
            ...
            if snake_queue[0]==8:
                val_3 = 50
            min_heuristic_positions = find_min_heuristic([val_1,val_2,val_3])
            print(f'Fidi pano:{val_1}, Fidi aristera:{val_2}, Fidi kato:{val_3}')
            if len(min_heuristic_positions)==1:    
                if val_1 >= val_3 and val_2>=val_3:
            ...
            if snake_queue[0]==7:
                val_2 = 50
            print(f'Fidi pano:{val_1}, Fidi deksia:{val_2}')    
            if val_1 >= val_2:
                change_position(position_7)
                refresh_game()
            else:
            ...
            if snake_queue[0]==8:
                val_3 = 50
            min_heuristic_positions = find_min_heuristic([val_1,val_2,val_3])
            print(f'Fidi pano:{val_1}, Fidi aristera:{val_2}, Fidi deksia:{val_3}')
            if len(min_heuristic_positions)==1:   
                if val_1 >= val_3 and val_2>=val_3:
                    change_position(position_8)
                    refresh_game()
            ...
            if snake_queue[0]==5:
                val_2 = 50
            print(f'Fidi aristera:{val_1}, Fidi pano:{val_2}')    
            if val_1 >= val_2:
                change_position(position_5)
                refresh_game()
            else:
